        ...
        <!--                                            <p class="help-block">In addition to freeform text, any HTML5 text-based input appears like so.</p>-->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <label style="margin-top: 10px;">Nombre de SMS : <span class="nombre_message"></span> &DoubleLongLeftRightArrow; Nombre de caractères : <span class="nombre_caractere"></span></label>
                                                </div>
                                            </div>
                                        </div> 
